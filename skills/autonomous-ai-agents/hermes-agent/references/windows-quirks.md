...
allowlist in `tools/code_execution_tool.py` covers it. If the error persists,
inspect only the required value: `print(repr(os.environ.get("SYSTEMROOT")))`.
Do not print the complete environment because it may contain credentials.
