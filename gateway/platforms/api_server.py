...
class APIServerAdapter(OpenAICompatRoutesMixin, BasePlatformAdapter):
    ...
    def _select_agent_runtime(
        ...
        session_override = None if confirmed_runtime_lock or strict_run else self._session_model_override_for(session_key)
        ...
        if session_override:
            ...
            if route or request_model or request_provider:
                logger.debug(
                    ...
                    session_key or "")
        elif session_row_model and not confirmed_runtime_lock and not strict_run:
    ...
    def _create_agent(
        ...
        strict_controls: Optional[Dict[str, Any]] = None) -> Any:
        ...
        model, session_override, request_model, request_provider = self._select_agent_runtime(
            ...
            gateway_session_key=gateway_session_key, session_id=session_id, strict_run=strict_run)
        ...
        agent_kwargs = {
            ...
            "fallback_model": None if confirmed_runtime_lock or strict_run else GatewayRunner._load_fallback_model(),
